...
\begin{frame}[fragile]{¿Cómo trabaja?}
  ...
  \item El programa \texttt{latex} procesa su text y  comandos para
    producir un documento de alta calidad tipográfica.
  \end{itemize}
  \vskip 2ex
  \begin{center}
    \begin{minted}[frame=single]{latex}
      La lluvia en España cae \emph{principalmente} en la llanura.
    \end{minted}
    \vskip 2ex
...
\begin{document}
% ahora podemos usar los comandos desde el paquete amsmath...
\end{document}
  \end{minted}
\end{itemize}
\end{frame}
