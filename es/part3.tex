  ...
  \item Agregue los comandos \LaTeX{} al texto para que se vean como
    ...
    \begin{center}
      \fbox{\href{\fileuri/recap-exercise-solution.pdf}{%
          Click para abrir el documento modelo}}
    \end{center}
  \end{enumerate}
  
  \begin{block}{Consejos}
    \begin{itemize}
    \item Utilice los entornos  \bftt{enumerate} y \bftt{itemize} para
      las listas.
    \item Para escribir el signo de porcentaje \keystrokebftt{\%},
...
\begin{frame}[fragile]{\insertsection: Secciones}
  \begin{itemize}
  \item Puede utilizar secciones para agrupar sus diapositivas, y de
...
e \textcolor{green}{inicia}.
    \end{exampletwouptiny}
    \vskip 1ex
  \item Vea \url{http://www.math.umbc.edu/~rouben/beamer/quickstart-Z-H-25.html}
